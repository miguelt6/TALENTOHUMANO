...
Public Class DOMFRM001
    ...
    Private Sub Guardar()
        ...
        Else
            ...
            Else
                Me.TxtNombreDpto.Text = PRIFRM001.Departamentos.Item(PosicionActual).ProNombre
                Me.TxtDescripcionDpto.Text = PRIFRM001.Departamentos.Item(PosicionActual).ProDescripcion
            End If
        End If
    End Sub
