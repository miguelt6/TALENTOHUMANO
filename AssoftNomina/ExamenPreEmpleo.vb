...
Public Class ExamenPreEmpleo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.ExamenPreEmpleo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExamenPreEmpleo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExamenPreEmpleo = New ExamenPreEmpleo()
        rpt.Site = Me.Site
        Return rpt
    End Function
