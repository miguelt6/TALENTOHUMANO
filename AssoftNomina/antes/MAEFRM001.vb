Public Class MAEFRM001
    ...
    Private Sub MAEFRM001_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If PRIFRM001.Departamentos.Count > 0 Then
            Cargar_Departamentos()
        Else
            MsgBox("No Ha Cargado Departamentos", MsgBoxStyle.Exclamation)
